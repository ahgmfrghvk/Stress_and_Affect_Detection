...
def calc_class_weight(labels_count):
    ...
    #mu = [factor * 1, factor * 1] # THESE CONFIGS ARE FOR SLEEP-EDF-20 ONLY
    ...
    class_weight = [(1-labels_count[0]/total).astype(np.float32), (labels_count[0]/total).astype(np.float32)]
