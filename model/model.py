...
class MRCNN(nn.Module):
    def __init__(self, afr_reduced_cnn_size):
        ...
        self.features1 = nn.Sequential(
            nn.Conv1d(1, 64, kernel_size=20, stride=1, bias=False, padding=10),
            nn.BatchNorm1d(64),
            #self.GELU,
            nn.ReLU(inplace=True),
        ...
        self.features2 = nn.Sequential(
            nn.Conv1d(1, 64, kernel_size=100, stride=3, bias=False, padding=50),
            nn.BatchNorm1d(64),
            #self.GELU,
            nn.ReLU(inplace=True),
            nn.MaxPool1d(kernel_size=4, stride=2, padding=2),
...
class AttnSleep(nn.Module):
    def __init__(self):
        ...
        d_model =44  # set to be 100 for SHHS dataset
